...
public class PostService {
    ...
    public Page<PostResponseDto> findPosts(Pageable pageable) {
        Page<Post> pagePost = postRepository.findAll(pageable);
        Page<PostResponseDto> responsePage = pagePost.map(post -> {
            return new PostResponseDto(post.getPostId(), post.getTitle(), post.getContent(), post.getUser().getUserId());
        });
        return responsePage;
    }
}
